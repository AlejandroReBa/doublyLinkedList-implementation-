...
public class DoublyLinkedList<T> {
	...
	private class DoublyLinkedNode<E> {
		private DoublyLinkedNode<E> prev; // A reference to the previous node
		private DoublyLinkedNode<E> next; // A reference to the next node;
		private E data; // Data or a reference to data;
	...
	private DoublyLinkedNode<T> firstNode; // points to first node of list
	private DoublyLinkedNode<T> lastNode; // points to last node of list
